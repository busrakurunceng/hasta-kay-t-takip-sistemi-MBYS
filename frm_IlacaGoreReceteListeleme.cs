...
{
    public partial class frm_IlacaGoreReceteListeleme : Form
    {
        public frm_IlacaGoreReceteListeleme()
        {
            InitializeComponent();
        }
        ...
        private void recete_listele_btn1_Click(object sender, EventArgs e)
        {
            recete_goster("select h.tckimlikno,h.ad ,h.soyad ,  r.recete_id , r.tarih,r.ilac_adi1,r.kutu_sayisi1 , r.ilac_adi2,r.kutu_sayisi2 ,r.ilac_adi3,r.kutu_sayisi3 , r.ilac_adi4,r.kutu_sayisi4, r.ilac_adi5,r.kutu_sayisi5, r.doktor_adi\nfrom receteler r \ninner join hastalar h on h.tckimlikno=r.tckimlikno " + "where r.ilac_adi1='" + ilac_adi_txtbox.Text + "' or r.ilac_adi2='" + ilac_adi_txtbox.Text + "' or r.ilac_adi3='" + ilac_adi_txtbox.Text +"' or r.ilac_adi3='"+ilac_adi_txtbox.Text+"' or r.ilac_adi4='" + ilac_adi_txtbox.Text + "' or r.ilac_adi5='" + ilac_adi_txtbox.Text + "' ORDER BY r.tarih ASC");
